...
if($config->get('isklad_status')){
    ...
    write_to_log("transport-type-list isklad - начало");
    $model_tool_isklad->transportTypeList();
    write_to_log("transport-type-list isklad - завершено");

    write_to_log("payment methods isklad - начало");
    $model_tool_isklad->paymentMethodList();
    write_to_log("payment methods isklad - завершено");

    write_to_log("Supplier isklad - начало");
    $model_tool_isklad->CreateSupplier();
    write_to_log("Supplier isklad - завершено");

    write_to_log("Order status list - начало");
    $model_tool_isklad->OrderStatusList();
    write_to_log("Order status list - завершено");
}
